...
package com.nvidia.spark.rapids.shims.sparkdb83;
...
class Sparkdb83ShimsSuite extends FunSuite {
  ...
  test("shuffle manager class") {
    assert(sparkShims.getRapidsShuffleManagerClass ===
      classOf[com.nvidia.spark.rapids.sparkdb83.RapidsShuffleManager].getCanonicalName)
  }
